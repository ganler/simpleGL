...
int main()
{
    ...
    SGL::sphere<quant_sz, quant_sz> wxball(-1, -0.4, 2, 2, 2, 2);
    ...
    /* Texture */
    auto im = cv::imread("../image/wx.jpg");
...
//    rzball.tex.parami(GL_TEXTURE_WRAP_S, GL_REPEAT);
//    rzball.tex.parami(GL_TEXTURE_WRAP_T, GL_REPEAT);
//    rzball.tex.parami(GL_TEXTURE_MIN_FILTER, GL_LINEAR);
//    rzball.tex.parami(GL_TEXTURE_MAG_FILTER, GL_LINEAR);
//    rzball.tex.parami(GL_TEXTURE_MIN_FILTER, GL_LINEAR_MIPMAP_LINEAR);
//    rzball.tex.parami(GL_TEXTURE_MAG_FILTER, GL_LINEAR_MIPMAP_LINEAR);
//    rzball.tex.load_image(im);
//    rzball.tex.mipmap();
